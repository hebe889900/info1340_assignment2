...
def decide(input_file, watchlist_file, countries_file):
    ...
    """
    #json.contents.input is where all traveler information including passport number, birth date etc.
    ...
    #json.contents.watchlist includes all traveler on the watchlist, travelers on this list can be sent to secondary
